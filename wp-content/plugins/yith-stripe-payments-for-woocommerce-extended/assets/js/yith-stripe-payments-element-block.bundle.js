...
;// CONCATENATED MODULE: ./assets/js/src/modules/PaymentElementBlock.js


/* globals wc jQuery Stripe yithStripePayments yithStripePaymentsElement */
...
function PaymentElementBlock_createSuper(Derived) { var hasNativeReflectConstruct = PaymentElementBlock_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
function PaymentElementBlock_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
 ...
 * Class that init and manages all interactions with Stripe Element
 */
var PaymentElementBlock = /*#__PURE__*/function (_PaymentElementChecko) {
  _inherits(PaymentElementBlock, _PaymentElementChecko);
  var _super = PaymentElementBlock_createSuper(PaymentElementBlock);
  /**
   * Constructor method
   */
  function PaymentElementBlock() {
    var _this;
    _classCallCheck(this, PaymentElementBlock);
    _this = _super.call(this);
    /**
     * Reference to node that works as elements wrapper
     */
    defineProperty_defineProperty(_assertThisInitialized(_this), "nodeRef", void 0);
    /**
     * Billing details
     */
    defineProperty_defineProperty(_assertThisInitialized(_this), "billing", void 0);
    _this.unmount = _this.unmount.bind(_assertThisInitialized(_this));
    _this.onPaymentProcessing = _this.onPaymentProcessing.bind(_assertThisInitialized(_this));
    return _this;
  }
   ...
   * Init current object
   */
  _createClass(PaymentElementBlock, [{
    key: "init",
    value: function init() {
      this.registerMethod();
      this.initStripe();
    ...
    value: function getMethod() {
      var _yithStripePaymentsEl2 = yithStripePaymentsElement,
        slug = _yithStripePaymentsEl2.slug,
        title = _yithStripePaymentsEl2.title,
        Label = this.getLabel(),
      ...
      return {
        ...
        ariaLabel: title,
        supports: {
          features: ['products'].concat(_toConsumableArray(yithStripePaymentsElement.tokenization ? ['tokenization'] : []))
        }
      };
    }
  }, {
    ...
    value: function getLabel() {
      return function (props) {
        var PaymentMethodLabel = props.components.PaymentMethodLabel,
          _yithStripePaymentsEl3 = yithStripePaymentsElement,
          title = _yithStripePaymentsEl3.title;
    ...
    value: function getContent() {
      var _this2 = this;
      var slug = yithStripePaymentsElement.slug;
      return function (props) {
        var billing = props.billing,
          ...
          _yithStripePaymentsEl4 = yithStripePaymentsElement,
          description = _yithStripePaymentsEl4.description;
        if (slug !== activePaymentMethod) {
          return;
        }

        // create reference for wrapper element.
        _this2.nodeRef = (0,external_wp_element_namespaceObject.useRef)();

        // registers current status of the billing details.
        _this2.billing = billing;
        ...
        (0,external_wp_element_namespaceObject.useEffect)(function () {
          return onPaymentProcessing(_this2.onPaymentProcessing);
        }, [onPaymentProcessing]);
        return /*#__PURE__*/React.createElement(React.Fragment, null, description ? /*#__PURE__*/React.createElement("p", null, description) : null, /*#__PURE__*/React.createElement("div", {
          id: _this2.target.replace('#', ''),
          ref: _this2.nodeRef
        }));
      };
    }
    ...
    value: function afterElementsSubmit() {
      ...
      return this.stripe.createPaymentMethod({
        ...
        return {
          type: 'success',
          meta: {
            paymentMethodData: defineProperty_defineProperty({}, "yith_stripe_payments_".concat(yithStripePaymentsElement.slug, "_payment_method"), paymentMethod.id)
          }
        };
      })["catch"](this.onError);
    }
    ...
    value: function unmount() {
      var _this$paymentElement;
      (_this$paymentElement = this.paymentElement) === null || _this$paymentElement === void 0 ? void 0 : _this$paymentElement.unmount();
    }
    ...
    value: function getBillingDetails() {
      var address = this.billing.billingAddress,
        name = "".concat(address.first_name, " ").concat(address.last_name);
      return {
        name: name,
        email: address === null || address === void 0 ? void 0 : address.email,
        phone: address === null || address === void 0 ? void 0 : address.phone,
    ...
    value: function getTarget(refresh) {
      if (!this.$target || refresh) {
        this.$target = $(this.getTargetNode());
      }
      return this.$target;
    }
  ...
  return PaymentElementBlock;
}(PaymentElementCheckout);

;// CONCATENATED MODULE: ./assets/js/src/element-block.js


/* global wc jQuery Stripe */

if (typeof wc !== 'undefined') {
  new PaymentElementBlock();
}
})();
...
/******/ })()
;
//# sourceMappingURL=yith-stripe-payments-element-block.bundle.js.map