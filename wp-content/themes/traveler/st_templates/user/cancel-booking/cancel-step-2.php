...
<div class="alert alert-info mt20" role="alert">
	<div class=""><strong><?php echo __( 'Please provide your account details so the admin can process the refund for you:', 'traveler' ); ?></strong></div>
		...
		if ( ! $st_is_woocommerce_checkout ) :
			...
			<div class="form-group">
				<label for="">
					...
					<span><?php echo __( 'Other method (depend on the admin availability)', 'traveler' ); ?></span>
				</label>
			</div>
		<?php endif; ?>
...
<div class="hidden form-get-account">
	...
	if ( ! $st_is_woocommerce_checkout ) :
		...
		<div data-value="your_stripe">
			<div class="form-group">
				<label for=""><?php echo __( 'Kindly provide detailed information: ', 'traveler' ) ?><span class="text-danger">(*)</span></label>
