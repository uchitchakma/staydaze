...
<div class="alert-user-package user-alert open">
  ...
  <div class="alert-content text-center">
    ...
    <p class="text-center"><?php echo __('You are not currently in any available membership package.', 'traveler') ?></p>
    <p class="text-center"><?php echo __('Please purchase or upgrade now!', 'traveler') ?></p>
    <?php
