...
$url = st_get_link_with_search( get_permalink(), [ 'start', 'date', 'duration', 'people' ], $_REQUEST );

?>
<div class="modern-search-result">
	<div class="item-service-map-new item-service grid-item">
		...
		<div class="service-border">
			<div class="thumb">
				...
				<?php do_action( 'st_list_compare_button', $post_id, get_post_type( $post_id ) ); ?>
				<?php echo st_get_avatar_in_list_service( $post_id, 70 ) ?>
			</div>
