...
?>
<div data-custom-class="search-datepicker" class=" form-group form-date-field form-date-search-v3 clearfix <?php echo esc_html($extraClass); ?> <?php if ($has_icon) echo ' has-icon '; ?>" data-format="<?php echo TravelHelper::getDateFormatMoment() ?>">
    <?php
    if ($has_icon) {
