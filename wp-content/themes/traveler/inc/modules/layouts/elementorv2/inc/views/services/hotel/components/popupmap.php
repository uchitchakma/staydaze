<?php
$zoom_map = get_post_meta( get_the_ID(), 'rs_hotel_map_room', true );
if ( empty( $zoom_map ) ) {
	$zoom_map = 13;
}
?>
<div class="map-view-popup style-2">
    ...
    <div id="map-search-form" class="full-map-form" data-disablecontrol="true" data-showcustomcontrol="true" data-zoom="<?php echo esc_attr( $zoom_map ); ?>"></div>
</div>