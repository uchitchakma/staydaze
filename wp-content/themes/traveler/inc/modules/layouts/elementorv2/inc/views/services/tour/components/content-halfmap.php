...
<div class="service-list-wrapper page-half-map map-right">
	<div class="col-left dataarea">
		<?php echo stt_elementorv2()->loadView( 'services/tour/components/toolbar', ['style' => $style] ); ?>
				...
				if ( $query->have_posts() ) {
					while ( $query->have_posts() ) {
						...
						echo '<div class="col-lg-6 col-md-6 col-12 item-service">';
							echo stt_elementorv2()->loadView( 'services/tour/loop/' . esc_html( $style ) );
						echo '</div>';
					...
					echo st()->load_template( 'layouts/elementor/tour/elements/none' );
					echo '</div>';
				}
				wp_reset_query();
				?>
