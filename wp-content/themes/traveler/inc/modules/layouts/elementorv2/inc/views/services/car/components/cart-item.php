    ...
    <ul>
        ...
        <li>
            ...
            <span class="value">
				...
				echo date(TravelHelper::getDateFormat() . ', ' . $string_time_format, $item['data']['check_in_timestamp']);
				?>
				-
				<?php echo date(TravelHelper::getDateFormat() . ', ' . $string_time_format, $item['data']['check_out_timestamp']); ?></span>
        </li>
		<li>
