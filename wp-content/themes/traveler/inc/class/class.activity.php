        ...
        class STActivity extends TravelerObject
        {
            ...
            function _get_where_query( $where )
            {
                ...
                if ( isset( $_REQUEST[ 'people' ] ) ) {
					...
					$where .= $wpdb->prepare( " AND (tb.max_people >= %s)", $people );
                }
                $start = esc_html( STInput::request( "start" ) );
                $end   = esc_html( STInput::request( "end" ) );
	            if ( !empty( $start ) && !empty( $end ) ) {
					...
					$where .= $wpdb->prepare( " AND {$wpdb->posts}.ID IN (%s)", $list_date );
	            }else{
                ...
                if ( isset( $_REQUEST[ 'star_rate' ] ) && !empty( $_REQUEST[ 'star_rate' ] ) ) {
                    ...
                    if ( $list_star ) {
						$where .= $wpdb->prepare( " AND (tb.rate_review IN (%s))", $list_star );
                    }
                }
