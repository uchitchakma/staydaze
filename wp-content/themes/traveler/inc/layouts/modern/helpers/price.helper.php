...
if(!class_exists('STPrice')){
    class STPrice{
         ...
         **/
        static function getSalePrice($post_id = '', $check_in = '', $check_out = '', $total_adult = 0){
            global $wpdb;
            $post_id = intval($post_id);
            ...
            if(is_array($cart) && count($cart)){
                foreach($cart as $key => $val){
                    ...
                    if(get_post_type($post_id) == 'st_rental'){
                        ...
                        $sale_price = STPrice::getSalePrice($rental_id, strtotime($check_in), strtotime($check_out), $adult_number);
