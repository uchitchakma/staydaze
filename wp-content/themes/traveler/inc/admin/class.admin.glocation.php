...
if(!class_exists('STGLocation')){
	class STGLocation{
		...
		public function _add_scripts(){
			...
			wp_localize_script('admin-glocation.js','adminGlocation', [
				'nonce' => wp_create_nonce('get_data_glocation')
			]);
		}
		...
		public function st_get_data_glocation(){
			...
			if ( ! isset( $_POST['security'] ) || !wp_verify_nonce( $_POST['security'], 'get_data_glocation' ) ) {
				echo json_encode( [
					'status'  => 'error',
