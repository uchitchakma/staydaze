    ...
    if ( !class_exists( 'STUpgradeData' ) ) {
        class STUpgradeData extends STAdmin
        {
            ...
            public function _add_scripts()
            {
				...
				wp_localize_script('admin-location-nested.js', 'adminLocationNested', [
					'nonce' => wp_create_nonce('get_data_location_nested')
				]);
            }
            ...
            public function st_get_data_location_nested()
            {
				...
				if ( ! isset( $_POST['security'] ) || !wp_verify_nonce( $_POST['security'], 'get_data_location_nested' ) ) {
					echo json_encode( [
						'status'  => 'error',
