            ...
            this.each(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if( $("input[name=st_payment_gateway]").length > 0 && $("input[name=st_payment_gateway]:checked").val() == 'vina_stripe' && typeof(data.order_id) != 'undefined' ){
                                ...
                                stripe.handleCardAction(
                                  ...
                                  if (result.error) {
									...
									if ( result.error.message ) {
										me.find('.form_alert').addClass('alert-danger').removeClass('hidden');
										me.find('.form_alert').html(result.error.message);
									}
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response_server) {
											...
											if (response_server.success) {
												...
												me.find('.form_alert').addClass('alert-danger').removeClass('hidden');
												me.find('.form_alert').html(response_server.data.message);
											}
                                        },
